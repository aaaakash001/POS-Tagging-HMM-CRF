...
with open(os.path.join(demo_files_dir, 'vocab.pkl'), 'rb') as f:
    vocab = pickle.load(f)

with open(os.path.join(demo_files_dir, 'tags.pkl'), 'rb') as f:
    tags = pickle.load(f)

with open(os.path.join(demo_files_dir, 'initial_probabilities.npy'), 'rb') as f:
    initial_probabilities = np.load(f)

with open(os.path.join(demo_files_dir, 'transition_matrix.npy'), 'rb') as f:
    transition_matrix = np.load(f)

with open(os.path.join(demo_files_dir, 'emission_matrix.npy'), 'rb') as f:
